...
export type GetMyNftPositionsQueryVariables = Exact<{
  origin: Scalars['Bytes']['input']
}>

export type GetMyNftPositionsQuery = {
  __typename?: 'Query'
  mints: Array<{
    __typename?: 'Mint'
    id: string
  ...
  definitions: [
    {
      ...
      operation: 'query',
      name: { kind: 'Name', value: 'GetMyNftPositions' },
      variableDefinitions: [
        {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'amount0' } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'feesUSD' } },
